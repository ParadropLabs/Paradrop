...
# Cute little premature optimization. I was bored.
'''

Note: unrelated to the rest of the contents of this file.

Isnt it annoying having to see and type .__dict__['asdfa']
when you're playing with classes that employ attr magic? Well be annoyed no more!

Mix this class into whichever magic class you're playing with and 
assign your own atter's:
...
class _Mirror(object):
    ...
    def __getattr__(self, k):
        return self.target.__dict__[k]


class TrueSet(object):

    def __new__(typ, *args, **kwargs):
        obj = object.__new__(typ, *args, **kwargs)
        mirror = _Mirror(obj)
        obj.__dict__['ts'] = mirror
        return obj
