from paradrop.backend import update_manager, update_object
from mock import patch, MagicMock

@patch('paradrop.backend.update_manager.out')
@patch('paradrop.backend.update_object')
@patch('paradrop.backend.update_manager.reloadChutes')
