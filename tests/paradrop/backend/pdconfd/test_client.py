...
@patch('paradrop.backend.pdconfd.client_dbus.out')
@patch('paradrop.backend.pdconfd.client_dbus.defer')
@patch('paradrop.backend.pdconfd.client_dbus.client')
...
@patch('paradrop.backend.pdconfd.client.callDeferredMethodDbus')
@patch('paradrop.backend.pdconfd.client.Blocking')
@patch('paradrop.backend.pdconfd.client.configManager')
