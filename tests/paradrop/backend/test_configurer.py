from paradrop.backend import configurer
from mock import patch, MagicMock

@patch('paradrop.backend.configurer.out')
@patch('paradrop.backend.configurer.updateObject')
@patch('paradrop.backend.configurer.reloadChutes')
